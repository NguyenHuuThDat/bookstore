        ...
        <footer class="bg-dark text-white text-center text-lg-start" style="margin-top: 40px">
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-12 mb-4 mb-md-0">
                        ...
                        <p>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Iste atque ea quis molestias. 
                            Fugiat pariatur maxime quis culpa corporis vitae repudiandae aliquam voluptatem veniam, est atque cumque eum delectus sint!
                        </p>
                    </div>
            ...
            <div class="text-center p-3" style="background-color: rgba(0, 0, 0, 0.2);">
                ...
                <a class="text-white" href="https://github.com/NguyenHuuThDat">Nguyen Huu Thanh Dat</a>
            </div>
        </footer>
