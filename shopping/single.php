...
<?php 
    if(isset($_POST['submit'])) {
        ...
        pro_price, pro_amount, pro_discount, pro_file, user_id) VALUES(:pro_id, :pro_name, :pro_image,
        :pro_price, :pro_amount, :pro_discount, :pro_file, :user_id)");
                            ...
                            <div class="product p-4">
                                ...
                                <p class="about"><?php echo $product->description; ?></p>
                                 <form method="post" id="form-data">
                                    ...
                                    <div class="">
                                        <input type="hidden"  name="pro_discount" value="<?php echo $product->discount; ?>" class="form-control">
                                    </div>
